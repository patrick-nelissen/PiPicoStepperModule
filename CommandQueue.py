...
class CommandSequence:
    ...
    def AddToQueue(self, string=""):
        ...
        while True :
            # Find the first match of a supported command
            ...
            matches = re.search("([APDZvVTL][0-9]*)|(R)", string)
    ...
    def ExecCommandQueue(self):
        ...
        for Command in self.CommandQueue:
            self.Match = re.search("^([APDZvVLTR])([0-9]*)$", Command)
